  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
      ...
      <p className="text-ink-muted text-sm max-w-md mb-8">
        Select a note in the sidebar or press <kbd className="bg-surface-2 border border-surface-3 rounded px-1.5 py-0.5 text-xs font-mono">⌘K</kbd> to search.
      </p>
